...
float positions[] = {
	...
	-0.5, -0.5, 0.5,	0.9f,		 0.0f, 0.0f,
	0.5, -0.5, 0.5,		0.9f,		 1.0f, 0.0f,
	0.5, 0.5, 0.5,		0.9f,		 1.0f, 1.0f,
	-0.5, 0.5, 0.5,		0.9f,		 0.0f, 1.0f,
	// back face
	-0.5, -0.5, -0.5,	0.6f,		 0.0f, 0.0f,
	-0.5, 0.5, -0.5,	0.6f,		 1.0f, 0.0f,
	0.5, 0.5, -0.5,		0.6f,		 1.0f, 1.0f,
	0.5, -0.5, -0.5,	0.6f,		 0.0f, 1.0f,
	// top face						 
	...
	0.5, -0.5, -0.5,	0.5f,		 1.0f, 0.0f,
	0.5, -0.5, 0.5,		0.5f,		 1.0f, 1.0f,
	-0.5, -0.5, 0.5,	0.5f,		 0.0f, 1.0f,
	// right face					 
	0.5, -0.5, -0.5,	0.8f,		 0.0f, 0.0f,
	0.5, 0.5, -0.5,		0.8f,		 1.0f, 0.0f,
	0.5, 0.5, 0.5,		0.8f,		 1.0f, 1.0f,
	0.5, -0.5, 0.5,		0.8f,		 0.0f, 1.0f,
	// left face					 
	-0.5, -0.5, -0.5,	0.7f,		 0.0f, 0.0f,
	-0.5, -0.5, 0.5,	0.7f,		 1.0f, 0.0f,
	-0.5, 0.5, 0.5,		0.7f,		 1.0f, 1.0f,
	-0.5, 0.5, -0.5,	0.7f,		 0.0f, 1.0f
};
...
{
	this->p_shader_player->SetUniformMat4f("pos", glm::rotate(glm::translate(glm::mat4(1), glm::vec3(x, y, z)), glm::radians(w), glm::vec3(1,0,0)));
